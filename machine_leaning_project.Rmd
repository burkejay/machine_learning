...
## Out-of-Bag error
The in-sample error is estimated from the Out-of-Bag error from the straight random forest run without cross-validation, at around 4%.  The out-of-sample error is measured when compared to the testing set.  I got 19 out of the 20 correct, for an error rate of 5%.  Here are the 19 correct, with an "x" for the one that was wrong.
